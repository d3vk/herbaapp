...
<body>
    <table>
        ...
        @php
            $i = 1;
        @endphp
        @foreach ($details['carts'] as $cart)
            <tr>
                <td>{{ $i }}</td>
                <td>{{ $cart->product[0]->name }}</td>
                <td>{{ $cart->quantity }}</td>
            </tr>
            @php
                $i++;
...
<body>
    <span class="preheader">Ini adalah pesanan baru untuk toko Anda. Segera persiapkan. Jangan lupa menunggu konfirmasi pembeli.</span>
                                                        ...
                                                        <table class="purchase_content" width="100%" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td width="80%" class="purchase_item"><span
                                                                        class="f-fallback">{{ $cart->product[0]->name }}</span>
                                                                </td>
                                                                <td class="align-right" width="20%"
                                                                    class="purchase_item"><span
                                                                        class="f-fallback">{{ $cart->quantity }}</span>
                                                                </td>
                                                            </tr>
                                                            @endforeach
